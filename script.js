...
function addremove() {
    ...
    let addButtons = document.querySelectorAll(".add-process-btn");
    for (let i = 0; i < process; i++) {
    ...
    let removeButtons = document.querySelectorAll(".remove-process-btn");
    for (let i = 0; i < process; i++) {
...
function addProcess() {
    ...
    let rowHTML1 = `
        ...
        <td class="priority-hide" rowspan="2"><input type="number" min="1" step="1" value="1" id="pr${process}" class="box"></td>
        ...
        <td class="process-btn" rowspan="2">
            <button type="button" class="add-process-btn">+</button>
            <button type="button" class="remove-process-btn">−</button>
        </td>
    `;
    let rowHTML2 = `
        <td class="process-time cpu process-input"><input type="number" min="1" step="1" value="1" id="bs${process}_1" class="box"></td>
    `;
...
function showGanttChart(output, outputDiv) {
    ...
    outputDiv.appendChild(ganttContainer);
}
...
function showTimelineChart(output, outputDiv) {
    ...
    outputDiv.appendChild(timelineContainer);
}
...
function compareAlgorithms() {
    try {
        ...
        if (primaryAlgo === "none" || secondaryAlgo === "none") {
            return;
        }
        ...
        compareResults.innerHTML = "<h3>Algorithm Comparison</h3>";
